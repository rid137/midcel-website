...
const Team = () => {
    return (
        <section>
            <CustomHero title="Company" subTitle="Team Members" />

            <div className="px-[1.25rem] text-center flex-co flex__column tracking-widest leading-relaxed my-8 md:my-16">
                <h4 className="text-primary sm:text-normal text-[.8rem]">Team Members</h4>
                <h2 className="font-bold text-normal sm:text-[1.5rem] md:text-[2.3rem]">Let's meet with our <br />team members</h2>
            </div>
