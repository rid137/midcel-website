...
import { serviceData, techDataLower, techDataUpper } from '@/utils/dummy'
    ...
    <section>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 w-full md:px-20 lg:px-24 px-[1.25rem] mb-8">
            {
                serviceData?.map(({id, img, title}) => (
                    <div key={id} className="bg-greyBg rounded-md flex__colum relative p-6 gap-6 cursor-default">
                        ...
                        <p className="text-[] text-[1.2rem] text-cente font-bold">{title}</p>
        ...
        <section>
            <div className="md:px-20 lg:px-24 px-[1.25rem] py-10">
                ...
                <p className="text-center text-black opacity-50 md:w-[50%] mt-4 mb-8 mx-auto">MidCel Software's has grown into an international contestant in software engineering with wide-ranging expertise in all the areas needed for reliable software development.</p>
